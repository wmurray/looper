...
It was 100% vibe-coded, written for personal use under specific conditions — a Rails codebase, Claude Code as the backend, and a particular set of workflow skills. As a result, some configuration assumptions are baked in rather than fully generalised. Consider it a reference or starting point, not a polished general-purpose tool. **Use at your own risk**
